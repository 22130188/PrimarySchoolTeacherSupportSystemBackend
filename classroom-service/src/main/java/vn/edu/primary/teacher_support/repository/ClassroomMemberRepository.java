...
public interface ClassroomMemberRepository extends JpaRepository<ClassroomMember, Long> {
    ...
    List<ClassroomMember> findByStudentIdAndStatusAndClassroomIsDeletedFalseOrderByJoinedAtDesc(Long studentId, MemberStatus status);
    ...
    long countByClassroomIdAndStatus(Long classroomId, MemberStatus status);
}
