...
public final class ActionLogLabels {
    ...
    private static final Map<String, String> EXACT = Map.ofEntries(
            ...
            Map.entry("REQUEST_PASSWORD_RESET_OTP", "Yêu cầu OTP đặt lại mật khẩu"),
            Map.entry("VERIFY_PASSWORD_RESET_OTP", "Xác thực OTP đặt lại mật khẩu"),
            Map.entry("RESET_PASSWORD", "Đặt lại mật khẩu"),
